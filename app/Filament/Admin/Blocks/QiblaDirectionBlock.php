...
class QiblaDirectionBlock extends BaseBlock
{
    public static function getBlockSchema(): array
    {
        return [
            ...
            Toggle::make('show_degree')
                ->label(__('Show Degree'))
                ->default(true),
            Toggle::make('show_distance')
                ->label(__('Show Distance to Kaaba'))
                ->default(true),
        ];
    }
    ...
    {
        return 'components.blocks.qibla-direction';
    }
}
